    ...
    {thrillerbooks.map((thrillerbook)=>(
        ...
        <div className='main-div'>
              ...
              <div className='content-div'>
                  <h6>
                  {thrillerbook.Bookname}
                  </h6>
                  <p>                
                      {thrillerbook.Description}
                  </p>
                  <p>{thrillerbook.Price}
                     <span>
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16" onClick={()=>dispatch(addtocart(thrillerbook))}>
